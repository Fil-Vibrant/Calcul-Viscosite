...
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/'../../../../Program Files/scilab-5.5.2/bin/' -lapi_scilab
...
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/'../../../../Program Files/scilab-5.5.2/bin/' -lcall_scilab
